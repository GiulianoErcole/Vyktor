...
def save_candidate(task_name, candidate):
    ...
    with open(f"results/runs/vyktor_best_{task_name}.json", "w", encoding="utf-8") as f:
        json.dump({"score": candidate.score, "ok": candidate.ok, "runtime": candidate.runtime, "origin": candidate.origin}, f, indent=2)
